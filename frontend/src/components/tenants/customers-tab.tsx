...
/** Kunden-Tab (ex-Hauptbereich der Konsole, jetzt Teil der Tab-Restrukturierung Task 7):
 *  Kunden-CRUD-Tabelle. Bezieht `tenants`/`isLoading` von der Elternseite (`tenants.tsx`),
 *  die die `admin-tenants`-Query hält -- wird auch von den Tabs Zuweisungen/Gruppen
 *  gebraucht, deshalb EIN gemeinsamer Query-Aufruf statt eines je Tab. */
