...
```
docker pull amslertec/pwnotify:0.1.5
```
...
| Tag | Meaning |
|---|---|
| `0.1.5` | Pinned release (recommended for production) |
...
```bash
docker scout cves amslertec/pwnotify:0.1.5            # vulnerability report
docker buildx imagetools inspect amslertec/pwnotify:0.1.5   # platforms + attestations
docker scout sbom amslertec/pwnotify:0.1.5            # software bill of materials
```
