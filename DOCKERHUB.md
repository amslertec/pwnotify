...
```
docker pull amslertec/pwnotify:0.1.6
```
...
| Tag | Meaning |
|---|---|
| `0.1.6` | Pinned release (recommended for production) |
...
```bash
docker scout cves amslertec/pwnotify:0.1.6            # vulnerability report
docker buildx imagetools inspect amslertec/pwnotify:0.1.6   # platforms + attestations
docker scout sbom amslertec/pwnotify:0.1.6            # software bill of materials
```
