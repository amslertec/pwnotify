...
```
docker pull amslertec/pwnotify:0.1.7
```
...
| Tag | Meaning |
|---|---|
| `0.1.7` | Pinned release (recommended for production) |
...
```bash
docker scout cves amslertec/pwnotify:0.1.7            # vulnerability report
docker buildx imagetools inspect amslertec/pwnotify:0.1.7   # platforms + attestations
docker scout sbom amslertec/pwnotify:0.1.7            # software bill of materials
```
