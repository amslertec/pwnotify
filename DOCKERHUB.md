...
```
docker pull amslertec/pwnotify:0.1.11
```
...
| Tag | Meaning |
|---|---|
| `0.1.11` | Pinned release (recommended for production) |
...
```bash
docker scout cves amslertec/pwnotify:0.1.11            # vulnerability report
docker buildx imagetools inspect amslertec/pwnotify:0.1.11   # platforms + attestations
docker scout sbom amslertec/pwnotify:0.1.11            # software bill of materials
```
