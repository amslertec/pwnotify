...
```
docker pull amslertec/pwnotify:0.1.2
```
...
| Tag | Meaning |
|---|---|
| `0.1.2` | Pinned release (recommended for production) |
...
```bash
docker scout cves amslertec/pwnotify:0.1.2            # vulnerability report
docker buildx imagetools inspect amslertec/pwnotify:0.1.2   # platforms + attestations
docker scout sbom amslertec/pwnotify:0.1.2            # software bill of materials
```
